...
var menuTable;
var menuTableBody;
var searchType;	// type of search: symbol, name, CGnum or FBgene
var organismID;	// dm, bm or aa
...
function initVars() 
{
	...
	organismID = document.getElementById("organism").value;
...
function findNames() 
{
	...
	if (inputField.value.length > 0) 
	{
		...
		var url = "/GutAuto/gutAuto.html?gene=" + encFieldValue
